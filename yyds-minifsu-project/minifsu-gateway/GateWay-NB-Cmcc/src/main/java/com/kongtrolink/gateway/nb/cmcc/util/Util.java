...
//        logger.info("check signature: result:{}  receive sig:{},calculate sig: {}",calSig.equals(obj.getMsg_signature()),obj.getMsg_signature(),calSig);
    ...
    public static BodyObj resolveBody(String body, boolean encrypted) throws JSONException {
        ...
        obj.setMsg_signature(jsonMsg.getString("msg_signature"));
        if (encrypted) {
    ...
    public static class BodyObj {
        ...
        public String toString(){
            return "{ \"msg\":"+this.msg+"，\"nonce\":"+this.nonce+"，\"msg_signature\":"+this.msg_signature+"}";
        }
