...
public class FindDevicesListApi extends AbstractAPI {
	...
	public BasicResponse<JSONObject> executeApi() {
...
//			DeviceList deviceList = JSONArray.toJavaObject((JSON) data,DeviceList.class);
//			Object newData = deviceList;/*mapper.readValue(mapper.writeValueAsString(response.getDataInternal()), DeviceList.class)*/;
