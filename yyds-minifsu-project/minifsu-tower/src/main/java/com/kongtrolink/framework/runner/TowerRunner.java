...
import com.kongtrolink.framework.execute.TowerExecuteService;
 ...
 */
@Component
public class TowerRunner implements ApplicationRunner
{
    private Logger logger = LoggerFactory.getLogger(this.getClass());

    @Autowired
    TowerExecuteService workerExecuteService;
