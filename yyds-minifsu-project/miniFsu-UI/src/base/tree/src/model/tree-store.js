...
export default class TreeStore {
  ...
  _initDefaultCheckedNodes () {
    ...
    // Amas added 初始化完毕
    if (Object.keys(this.nodesMap).length > 0) {
      this.tree.$emit('tree-ready')
    }
  }
  ...
  // 将所有的节点的checked值设置为value
  setAllNodeChecked (value) {
    for (let nodeKey in this.nodesMap) {
      if (this.nodesMap.hasOwnProperty(nodeKey)) {
        this.nodesMap[nodeKey].setChecked(value)
      }
    }
  }
}
