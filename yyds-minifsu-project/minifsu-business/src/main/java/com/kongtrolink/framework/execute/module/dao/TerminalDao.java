...
public class TerminalDao {
    ...
    public List<Terminal> findTerminalByUserId(String userId) {
        return mongoTemplate.find(Query.query(Criteria.where("userId").is(userId)), Terminal.class, MongoTableName.TERMINAL);
