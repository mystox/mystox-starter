package com.kongtrolink.framework.node.worker.execute;
 ...
 */
@Service
public class WorkerExecuteService implements ServiceInterface
{
    ...
    {
        logger.info("WorkerExecute service start... ...");
        if(initRpcModule())
