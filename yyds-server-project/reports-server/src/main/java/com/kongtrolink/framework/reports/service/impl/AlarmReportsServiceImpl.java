...
public class AlarmReportsServiceImpl implements AlarmReportsService {
    ...
    private ReportData AlarmCountQuery(ReportConfig reportConfig) {
        ...
        List<JSONObject> alarmCountList = alarmCountTempDao.getCountDataByCondition(taskId, siteList, alarmLevel, statisticLevel, period, timePeriod);
        //todo 获取本月告警分类数据

        //统计告警量

        String[][][] resultData = AlarmDataCreate(alarmCountList, statisticLevel);
    ...
    private String[][][] AlarmDataCreate(List<JSONObject> alarmCountList, String statisticLevel) {
        ...
        int rowLength = alarmCountList.size() + 1; //列
    ...
    private String AlarmCountExcelCreate(String sheetName, String[][][] resultData) {
        ...
        String filename = "告警量统计表_" + currentTime + ".xls";
    ...
    private String alarmDetailsExcelCreate(String sheetName, String[][][] resultData) {
        ...
        String filename = "告警明细表_" + currentTime + ".xls";
        WorkbookUtil.save("." + path, filename, WorkbookUtil.createWorkBook(new String[]{sheetName}, resultData));
        return path +"/"+ filename;
    }
    ...
    private String[][][] alarmDetailsDataCreate(List<JSONObject> detailsList) {
        ...
        int colLength = tableHead.length; // 行
        int rowLength = detailsList.size() + 1; //列
        String[][] sheetData = new String[colLength][rowLength];
    ...
    private String[][][] alarmCategoryDataCreate(List<JSONObject> alarmCategoryList, String statisticLevel) {
        ...
        int colLength = tableHead.length; // 行
        int rowLength = alarmCategoryList.size() + 1; //列
        String[][] sheetData = new String[colLength][rowLength];
