...
(function(){
    ...
    var MarkerClusterer =  
        ...
        BMapLib.MarkerClusterer = function(map, options){
            ...
            var that = this;
            this._mapMoveCallback = function(){
                that._redraw();     
            }
            this._map.addEventListener("zoomend", this._mapMoveCallback);
    
            this._map.addEventListener("moveend", this._mapMoveCallback);
   
            var mkrs = opts["markers"];
            isArray(mkrs) && this.addMarkers(mkrs);
        };

    MarkerClusterer.prototype.dispose = function () {        
        try {
            this._map.removeEventListener("zoomend", this._mapMoveCallback);    
            this._map.removeEventListener("moveend", this._mapMoveCallback);
            this._markers.forEach(function (v) {
                v.remove();
            });
            this._clusters.forEach(function (v) {
                v.remove();
            });
        } catch (e) {
            return;
    ...
    Cluster.prototype.updateClusterMarker = function (bDelayDraw) {        
        this._level = this._markers.reduce(function (o, n) { return Math.min(o, n.topAlarm === 0 ? Infinity : n.topAlarm); }, Infinity);
        if (this._level > 4) {
            this._level = 0;
        }
        ...
        this._clusterMarker.setText(this._markers.length, this._level, this._markers.length);
