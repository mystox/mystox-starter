 ...
 * @author Mag
 */
public class HistoryMapXlsExporter {

    public static final int PAGE_SIZE = 60000;
    public static final int LIMIT = 200000;

    public static SXSSFWorkbook exportMap(List<HistoryDataEntity> data, String[] properiesName, String[] headsName, String sheetName) throws IOException {
        ...
        do {
            for(int i=0;i<data.size();i++){
				...
				HistoryDataEntity stat = data.get(i);
    			...
    			for (int iCol = 0; iCol < properiesName.length; iCol++) {
    				try {
    					...
    					Object obj = value.get(properiesName[iCol]);
    					if (obj == null) {
    						//cell.setCellValue("-");
    						continue;
    					}
