//@ sourceURL=angular.js
/**
 * @license AngularJS v1.2.17
 * (c) 2010-2014 Google, Inc. http://angularjs.org
 * License: MIT
 */
window.angular || (function(window, document, undefined) {'use strict';
...
var styleDirective = valueFn({
  ...
  // add by Amas (控制angular的延时加载)
  window.angular.init = function () {angularInit(document, bootstrap)}
