    ...
    jet.extend(jeDatePick.prototype,{
        init : function () {  
            ...
            var getCurrValue = function () {
                ...
                that.selectValue = that.selectValue || [jet.parse(jet.getDateTime({}), parmat)];
                if(isEmpty && isShow){
        ...
        methodEventBind : function() {
            ...
            jet.extend(that,{
                    ...
                    if(range){
                        ...
                        if(opts.onClose){  
                            ...
                            if (that.dlen > 3) {                            
                                ...
                                jet.text(that.dateCell.querySelector('.timecon'),disNo ? opts.language.backtxt:opts.language.timetxt[0]);
                ...
                hmsClick:function(idx,num) {
                    if (jet.lastTimeClick && jet.lastTimeClick[0] === parseInt(num) && new Date().getTime() - jet.lastTimeClick[1] < 300) {
                        that.sureBtn();
                        return;
                    }
                    ...
                    jet.lastTimeClick=[pidx, new Date().getTime()];
                },
                timeBtn:function() {
                    var timeCell = $Q(".jedate-time",elCell), disNo = timeCell.style.display == "none";
