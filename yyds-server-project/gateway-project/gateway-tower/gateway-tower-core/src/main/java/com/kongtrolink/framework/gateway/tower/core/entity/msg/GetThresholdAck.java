...
public class GetThresholdAck extends Info {
    ...
    public PKType pkType() {
        return new PKType(CntbPktTypeTable.GET_THRESHOLD_ACK, CntbPktTypeTable.GET_THRESHOLD_ACK_CODE);
    }

    public GetThresholdAck() {
