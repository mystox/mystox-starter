...
public class FSUServiceServiceStub extends org.apache.axis2.client.Stub {
     ...
     * @param invoke14
     */
    public com.chinatowercom.fsuservice.InvokeResponse invoke(
        com.chinatowercom.fsuservice.Invoke invoke14)
        ...
        try {
            ...
            ops.setProperty(HTTPConstants.CONNECTION_TIMEOUT,5000);//超时设置5秒
            ops.setProperty(HTTPConstants.SO_TIMEOUT,5000);//超时设置5秒
            ...
            Object object = fromOM(_returnEnv.getBody()
                                                       .getFirstElement(),
                    com.chinatowercom.fsuservice.InvokeResponse.class);

            return (com.chinatowercom.fsuservice.InvokeResponse) object;
     ...
     */
    public void startinvoke(com.chinatowercom.fsuservice.Invoke invoke14,
                            final com.chinatowercom.fsuservice.FSUServiceServiceCallbackHandler callback)
        throws java.rmi.RemoteException {
        org.apache.axis2.client.OperationClient _operationClient = _serviceClient.createClient(_operations[0].getName());
        _operationClient.getOptions()
                        .setAction("http://FSUService.chinatowercom.com/FSUService/invokeRequest");
                ...
                public void onMessage(
                    ...
                    try {
                        ...
                        Object object = fromOM(resultEnv.getBody()
                                                                  .getFirstElement(),
                                com.chinatowercom.fsuservice.InvokeResponse.class);
                        callback.receiveResultinvoke((com.chinatowercom.fsuservice.InvokeResponse) object);
    ...
    private org.apache.axiom.om.OMElement toOM(
            com.chinatowercom.fsuservice.Invoke param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(com.chinatowercom.fsuservice.Invoke.MY_QNAME,
    ...
    private org.apache.axiom.om.OMElement toOM(
        com.chinatowercom.fsuservice.InvokeResponse param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(com.chinatowercom.fsuservice.InvokeResponse.MY_QNAME,
                org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                    ...
                    com.chinatowercom.fsuservice.Invoke.MY_QNAME, factory));
    ...
    private Object fromOM(org.apache.axiom.om.OMElement param,
        ...
        try {
            if (com.chinatowercom.fsuservice.Invoke.class.equals(type)) {
                return com.chinatowercom.fsuservice.Invoke.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }

            if (com.chinatowercom.fsuservice.InvokeResponse.class.equals(type)) {
                return com.chinatowercom.fsuservice.InvokeResponse.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
        } catch (Exception e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
