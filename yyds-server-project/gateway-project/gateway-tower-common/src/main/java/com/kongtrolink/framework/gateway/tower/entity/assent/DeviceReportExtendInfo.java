...
public class DeviceReportExtendInfo extends DeviceReportExtend{
    ...
    public DeviceReportExtendInfo() {
    }

    public DeviceReportExtendInfo(PushDeviceAssetDevice device) {
        setModel(device.getModel());
        this.name = device.getName();
        this.resourceNo = device.getResourceNo();
        this.versionMajor = device.getVersionMajor();
        this.versionMinor = device.getVersionMinor();
        this.versionRevision = device.getVersionRevision();
    }
