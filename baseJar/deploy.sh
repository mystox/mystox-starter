...
DEPLOY_URL=http://nexus.mystox.tech:8881/repository/maven-releases/
REPOSITORY_Id=releases
VERSION=3.5.26.RELEASE
...
mvn deploy:deploy-file -DrepositoryId=$REPOSITORY_Id -Durl=$DEPLOY_URL -DgeneratePom=true -DgroupId=tech.mystox.framework -DartifactId=yyds-iarpc-starter -Dversion=$VERSION -Dpackaging=jar -Dfile=$BASE_DIR/yyds-iarpc-starter-$VERSION.jar
